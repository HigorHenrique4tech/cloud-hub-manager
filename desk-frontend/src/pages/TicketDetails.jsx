      ...
      <div className="card p-4 space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium border ${sCfg.cls}`}>{sCfg.label}</span>
          </div>
          <div className="flex items-center justify-between">
...
const TicketDetails = () => {
  ...
  const handleSend = () => { if (reply.trim()) sendMut.mutate(reply.trim()); };
        ...
        <div className="flex gap-6 items-start">
          <div className="flex-1 flex flex-col gap-4">
            ...
            {isClosed ? (
              ...
              <div className="card p-4 space-y-3">
                <textarea value={reply} onChange={(e) => setReply(e.target.value)} onKeyDown={handleKeyDown} rows={3}
