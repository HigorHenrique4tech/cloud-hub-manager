      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3 min-w-0">
          <div className="w-9 h-9 rounded-lg bg-primary-50 dark:bg-indigo-900/30 flex items-center justify-center flex-shrink-0">
            <Building2 className="w-4 h-4 text-primary-dark dark:text-primary-light" />
          </div>
          <div className="min-w-0">
...
function SetupBanner() {
  ...
  return (
    <div className="mb-6 p-4 rounded-xl border border-amber-300 dark:border-amber-700 bg-amber-50 dark:bg-amber-900/20">
      <div className="flex items-start justify-between gap-4">
        <div className="flex gap-3">
          <Shield className="w-5 h-5 text-amber-600 dark:text-amber-400 flex-shrink-0 mt-0.5" />
          <div>
            <p className="text-sm font-semibold text-amber-800 dark:text-amber-200 mb-1">Configuração necessária (1x por parceiro)</p>
            <ol className="text-xs text-amber-700 dark:text-amber-300 space-y-1 list-decimal list-inside">
              <li>
                Adicione a permissão <code className="font-mono bg-amber-100 dark:bg-amber-900/40 px-1 rounded">DelegatedAdminRelationship.ReadWrite.All</code> ao App Registration e conceda admin consent.
              </li>
              <li>
                Provisione o Service Principal do parceiro (uma única vez):
                <code className="block font-mono bg-amber-100 dark:bg-amber-900/40 px-2 py-1 rounded mt-1 text-xs break-all">
                  {'POST https://graph.microsoft.com/v1.0/servicePrincipals { "appId": "2832473f-ec63-45fb-976f-5d45a7d4bb91" }'}
                </code>
              </li>
            </ol>
          </div>
        </div>
        <button onClick={() => setDismissed(true)} className="text-amber-500 hover:text-amber-700 dark:hover:text-amber-300 flex-shrink-0">
          <X className="w-4 h-4" />
        </button>
      </div>
    </div>
...
export default function GdapManager() {
  ...
  return (
    <Layout>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-1">GDAP Manager</h1>
          <p className="text-gray-600 dark:text-gray-400">
            Gerenciar delegações de acesso com tenants de clientes Microsoft 365
          </p>
        </div>
        <div className="flex items-center gap-2">
          <button
