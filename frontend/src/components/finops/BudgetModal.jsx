    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fade-in">
      <div className="w-full max-w-md rounded-2xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-2xl animate-scale-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 px-5 py-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                disabled={isEdit}
                className="w-full rounded-lg border border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 text-sm text-gray-900 dark:text-slate-100 disabled:opacity-50"
              >
          ...
          {isEdit && (
            <p className="text-xs text-gray-400 dark:text-slate-500 -mt-1">Provider e período não podem ser alterados após a criação.</p>
          )}
          <div>
