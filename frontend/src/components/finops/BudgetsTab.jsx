...
const BudgetCard = ({ budget, onDelete, onEdit }) => {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white dark:border-slate-700 dark:bg-slate-800/60 p-4
        ...
        <div className="flex items-center gap-2">
          <PermissionGate permission="finops.budget">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-lg border border-gray-300 dark:border-slate-600 px-3 py-2 text-sm font-medium text-gray-600 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-700 disabled:opacity-50 transition-colors active:scale-[0.97]"
            >
