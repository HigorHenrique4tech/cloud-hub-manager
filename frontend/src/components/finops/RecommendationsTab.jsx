    ...
    <div className="flex flex-wrap gap-2">
      ...
      <div className="ml-auto flex gap-2">
        <button
          onClick={onExportCSV}
          title="Exportar CSV"
          className="inline-flex items-center gap-1.5 rounded-lg border border-gray-300 dark:border-slate-700 px-3 py-1.5 text-xs font-medium text-gray-600 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors active:scale-[0.97]"
        >
          <FileDown size={13} />
          CSV
        </button>
