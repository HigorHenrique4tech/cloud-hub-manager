    ...
    <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 font-mono">{resourceId}</p>
          </div>
        </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm font-medium text-gray-900">{resourceType || 'N/A'}</span>
        </div>
        ...
        {isAWS && resource.availability_zone && (
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm font-medium text-gray-900">{resource.availability_zone}</span>
          </div>
        )}
        ...
        {isAWS && resource.public_ip && (
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-600">IP Público</span>
            <span className="text-sm font-mono text-gray-900">{resource.public_ip}</span>
          </div>
        )}
        ...
        {!isAWS && resource.resource_group && (
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm font-mono text-gray-900">{resource.resource_group}</span>
          </div>
        )}
      </div>
    </div>
